...
- **gitftp** (0.9.0)   Gitftp: a git powered FTP client written as shell script.  
...
- **haxe** (3.1.3)  Haxe: an open source toolkit. 
...
- **neko** (2.0.0)  Neko: high-level dynamicly typed programming language.                                   
...
- **php5-phalcon** (1.3.2) Phalcon web framework
...
- **postgresql** (9.3.5) PostgreSQL: The world's most advanced open-source database system
...
- **python2** (2.7.8) Python 2: The most friendly Programming Language
- **python3** (3.4.1-2) Python 3: Next generation of the most friendly Programming Language    
...
- **uuid** (1.6.2) OSSP uuid: an API and corresponding CLI for the generation of DCE 1.1, ISO/IEC 11578:1996 and RFC 4122 compliant Universally.

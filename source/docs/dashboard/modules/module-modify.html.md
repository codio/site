...
You can edit the source Codio project by opening it from your normal Codio projects list. Alternatively, if you are viewing the Unit in the Modules list, you can open it by clicking on Module, enable the 'Edit Unit' button and then the select the unit and press the `Edit Original` button.

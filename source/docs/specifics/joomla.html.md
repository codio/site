...
1. Check the [Joomla website](http://joomlacode.org/gf/project/joomla/frs) to see what the latest **Full Package** release version is. At the time of writing, it is 3.3.3.
1. Note down the latest version number ready to modify the url specified in the next step.
1. From the terminal, `wget http://joomlacode.org/gf/download/frsrelease/19665/160051/Joomla_3.3.3-Stable-Full_Package.tar.gz` 
1. Unzip the download file using `tar zxvf Joomla_3.3.3-Stable-Full_Package.tar.gz`
1. Now delete the zip file `rm Joomla_3.3.3-Stable-Full_Package.tar.gz`
